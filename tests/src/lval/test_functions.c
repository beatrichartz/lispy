...
void test_head_with_too_many_args(test *t) {
    ...
    test_assert(strcmp(h->err, "Function 'head' passed too many arguments") ==
                0);
...
void test_head_with_wrong_type(test *t) {
    ...
    lval *h = builtin_head(a);
    test_assert(h->type == LVAL_ERR);
    test_assert(strcmp(h->err, "Function 'head' passed an incorrect type") ==
                0);
...
void test_cons_with_too_few_args(test *t) {
    ...
    lval *h = builtin_cons(x);
    test_assert(h->type == LVAL_ERR);
    test_assert(strcmp(h->err, "Function 'cons' passed too few arguments") ==
                0);
...
void test_cons_with_too_many_args(test *t) {
    ...
    lval *h = builtin_cons(x);
    test_assert(h->type == LVAL_ERR);
    test_assert(strcmp(h->err, "Function 'cons' passed too many arguments") ==
                0);
...
void test_tail_with_too_many_args(test *t) {
    ...
    test_assert(h->type == LVAL_ERR);
    test_assert(strcmp(h->err, "Function 'tail' passed too many arguments") ==
                0);
...
void test_tail_with_wrong_type(test *t) {
    ...
    lval *h = builtin_tail(a);
    test_assert(h->type == LVAL_ERR);
    test_assert(strcmp(h->err, "Function 'tail' passed an incorrect type") ==
                0);
...
void test_init_with_too_many_args(test *t) {
    ...
    test_assert(h->type == LVAL_ERR);
    test_assert(strcmp(h->err, "Function 'init' passed too many arguments") ==
                0);
...
void test_init_with_wrong_type(test *t) {
    ...
    lval *h = builtin_init(a);
    test_assert(h->type == LVAL_ERR);
    test_assert(strcmp(h->err, "Function 'init' passed an incorrect type") ==
                0);
...
void test_eval_with_too_many_args(test *t) {
    ...
    test_assert(h->type == LVAL_ERR);
    test_assert(strcmp(h->err, "Function 'eval' passed too many arguments") ==
                0);
...
void test_eval_with_wrong_type(test *t) {
    ...
    lval *h = builtin_eval(a);
    test_assert(h->type == LVAL_ERR);
    test_assert(strcmp(h->err, "Function 'eval' passed an incorrect type") ==
                0);
...
void test_join_with_wrong_type(test *t) {
    ...
    lval *h = builtin_join(c);
    test_assert(h->type == LVAL_ERR);
    test_assert(strcmp(h->err, "Function 'join' passed an incorrect type") ==
                0);
...
void test_len_with_too_many_args(test *t) {
    ...
    lval *h = builtin_len(x);
    test_assert(h->type == LVAL_ERR);
    test_assert(strcmp(h->err, "Function 'len' passed too many arguments") ==
                0);
